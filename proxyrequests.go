...
func (req *Request) Send(method string, origurl string, args ...interface{}) (resp *Response, err error) {
	...
	for _, arg := range args {
		...
		case string:
			...
			req.setBodyRawBytes(io.NopCloser(strings.NewReader(a)))
		case SetTimeout:
		...
		case Proxy:
			...
			case "socks5", "socks", "socks5h":
				...
				thisTransport.DialContext = func(ctx context.Context, network, addr string) (net.Conn, error) {
